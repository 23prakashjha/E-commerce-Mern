    ...
    <div className="max-w-full mx-auto overflow-x-hidden">
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden rounded-none sm:rounded-3xl sm:mx-2 lg:mx-8 bg-gradient-to-br from-gray-950 via-gray-900 to-orange-950">
        ...
        <motion.div
          ...
          className="absolute top-40 right-[20%] w-2 h-2 rounded-full bg-yellow-400/50 hidden lg:block"
        />
        <motion.div
          animate={{ y: [-8, 8, -8] }}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 w-full">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-white/70 mb-10 text-base sm:text-lg max-w-xl mx-auto lg:mx-0 leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                ...
                <Link
                  to="/about"
                  className="inline-flex items-center justify-center gap-2 border border-white/20 text-white px-10 py-4 rounded-2xl font-semibold hover:bg-white hover:text-gray-900 transition-all duration-300 text-base"
                >
            ...
            >
              ...
              <motion.div
                ...
                className="mt-6 bg-white/5 backdrop-blur-2xl rounded-2xl p-5 border border-white/10 flex items-center justify-around"
              >
      ...
      <section className="mb-16 py-16 overflow-hidden bg-gray-50">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="flex gap-6 py-4" style={{ animation: "scrollBrands 30s linear infinite" }}>
      ...
      <section className="mb-16 bg-gradient-to-br from-orange-50 to-white py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="md:hidden relative">
          <div className="flex gap-4 overflow-x-auto pb-4 snap-x snap-mandatory px-2" style={{ scrollbarWidth: "none", msOverflowStyle: "none", WebkitOverflowScrolling: "touch" }}>
            {testimonials.map((t, i) => (
              <div
                key={t.name}
                className="min-w-[280px] max-w-[300px] snap-center bg-white p-6 rounded-2xl shadow-md border border-gray-50 flex-shrink-0"
              >
        ...
        <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {testimonials.map((t, i) => (
            <motion.div
              ...
              whileInView="visible"
              custom={i}
              className="bg-white p-7 rounded-2xl shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-gray-50"
            >
              <StarRating rating={t.rating} />
      ...
      <section className="mb-16 bg-gradient-to-br from-gray-50 to-white py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          {blogPosts.map((post, i) => (
            ...
            >
              <div className="bg-white rounded-3xl shadow-md hover:shadow-2xl overflow-hidden transition-all duration-500 hover:-translate-y-2 border border-gray-100">
                <div className={`bg-gradient-to-br ${blogGradients[i]} h-52 flex items-center justify-center overflow-hidden relative`}>
                  <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors duration-500" />
                  <div className="text-7xl font-extrabold text-white/20 group-hover:scale-125 group-hover:text-white/30 transition-all duration-700 select-none">
                    {post.tag[0]}
                  </div>
          ...
          {socialPosts.map((post, i) => {
            ...
            return (
              <motion.a
                ...
                whileInView="visible"
                custom={i}
                className={`group relative bg-gradient-to-br ${post.gradient} aspect-square rounded-3xl flex flex-col items-center justify-center gap-3 hover:scale-105 hover:-rotate-1 transition-all duration-500 cursor-pointer shadow-lg hover:shadow-2xl overflow-hidden`}
              >
                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/30 transition-colors duration-500" />
                <div className="absolute inset-0 flex items-center justify-center opacity-10 group-hover:opacity-20 transition-opacity duration-500">
                  <Icon className="w-32 h-32" />
                </div>
                <Icon className="w-8 h-8 text-white opacity-80 group-hover:opacity-100 transition-all duration-300 relative z-10 group-hover:scale-110" />
        ...
        <div className="max-w-3xl mx-auto mt-10 bg-gradient-to-r from-gray-50 to-orange-50 rounded-3xl p-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="text-center sm:text-left">
              ...
              <p className="text-gray-500 text-sm mt-1">Follow for exclusive deals, style tips, and behind-the-scenes content</p>
            </div>
            <div className="flex gap-3">
              {[
                ...
                <a
                  ...
                  href="#"
                  aria-label={label}
                  className={`p-3 bg-white rounded-2xl text-gray-600 ${color} hover:text-white transition-all duration-300 shadow-sm hover:shadow-lg hover:-translate-y-1`}
                >
                  <Icon size={20} />
                </a>
              ))}
