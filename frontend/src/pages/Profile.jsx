                  ...
                  return (
                    ...
                    >
                      <div className="flex justify-between items-start">
                        ...
                        <span className={`px-3 py-1 rounded-full text-sm font-semibold ${statusColors[order.orderStatus] || "bg-gray-100 text-gray-800"}`}>
                          ...
                          {isExpanded && (
                            ...
                            >
                              {order.orderItems?.map((item, idx) => (
                                <div key={item.product + "-" + idx} className="flex justify-between text-sm py-1 border-b last:border-b-0">
