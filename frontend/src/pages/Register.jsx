...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-orange-100 via-white to-orange-50 px-4 py-10">
      <motion.div
      ...
      >
        ...
        <div className="p-8 sm:p-12">
          ...
          <div className="flex bg-gray-100 rounded-xl p-1 mb-8">
            <button
              ...
              className={`flex-1 py-2.5 rounded-lg text-sm font-semibold transition ${
                mode === "user" ? "bg-white text-orange-600 shadow-sm" : "text-gray-500 hover:text-gray-700"
              }`}
            >
          ...
          <div className="grid grid-cols-2 gap-4">
            <button type="button" className="border py-3 rounded-xl hover:bg-gray-50 transition font-medium">Google</button>
            <button type="button" className="border py-3 rounded-xl hover:bg-gray-50 transition font-medium">Facebook</button>
          </div>
