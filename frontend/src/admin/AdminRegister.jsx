    ...
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-gray-50 to-orange-50 dark:from-gray-900 dark:to-gray-800 px-4 py-10">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-3xl font-extrabold text-gray-800 dark:text-gray-100">Admin Registration</h2>
        ...
        <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
          <div>
            <label className="text-gray-600 dark:text-gray-300 text-sm font-medium mb-1.5 block">Full Name</label>
            <input type="text" name="name" value={formData.name} onChange={handleChange}
              placeholder="Enter your name" required
              className="w-full border border-gray-300 dark:bg-gray-900 dark:text-gray-100 dark:border-gray-600 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-orange-500 transition" />
          </div>
          <div>
          ...
          <div>
            ...
            <div className="relative">
              <input type={showPwd ? "text" : "password"} name="password" value={formData.password} onChange={handleChange}
                ...
                className="w-full border border-gray-300 dark:bg-gray-900 dark:text-gray-100 dark:border-gray-600 rounded-xl px-4 py-3 pr-12 focus:outline-none focus:ring-2 focus:ring-orange-500 transition" />
          ...
          <div>
            <label className="text-gray-600 dark:text-gray-300 text-sm font-medium mb-1.5 block">Confirm Password</label>
